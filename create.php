...
<body>
    ...
    <section id="form-account">
        <form action="create.php" method="POST">
            ...
            <input type="password" name="senhaconf" id="senhaconf" placeholder="Confirmar Senha" maxlength="15">
            <input type="submit" id="submit" class="normal" name="submit" value="Cadastrar-se">
            <br>
        </form>
    </section>
